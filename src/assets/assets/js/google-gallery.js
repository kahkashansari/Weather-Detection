$(function () {
    ...
    $(".picflex .resultitem > .box > a.clickevent").click(function (e) {
        
      
        $(this).parent().parent().find('.addToOrder').children().attr('title', $(this).parent().find('.cart-add').attr('title'));
        
        $(".picflex .resultitem").removeClass("open").css('min-height',0 );
        var heigh_count =  $(this).parent().next().height();
        var counterH = $('.viewchange .resultitem .box').height();
        
        var addH  = heigh_count + counterH;
       
        $(this).parent().parent().addClass("open").css('min-height',addH );
   ...
   $(".picflex .resultitem > .box > a.clickevent").click(function (e) { 
        $(this).parent().addClass('is-active');
         console.log('par-click');
         });
    
        $(".picflex .resultitem > .box .arrow_down.thumbnailurl a").click(function () {
            console.log('sec-click');
         $(this).parent().parent().removeClass('is-active');
            
             $(this).parent().addClass('is-akhgytar');
    ...
    $(window).bind("load resize", function() {
        var root = $('picflex .resultitem > .box > a');
        var heigh_count =  $(this).parent().next().height();
        var counterH = $('.viewchange .resultitem .box').height();
        
        var addH  = heigh_count + counterH;
       
        $(root).parent().parent().addClass("open").css('min-height',addH );
        
    });
    
      $(window).on("load", function() {
        $(".pictureView .resultitem:nth-child(3) a.clickevent").click();
//        alert("kk");
    });
