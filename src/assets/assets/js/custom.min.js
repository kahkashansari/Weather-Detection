...
$(function () {
    ...
    $(".picflex .resultitem > .box > a").click(function (e) {
        ...
        $(this).addClass("active"), "picflex" != t ? $(".viewchange").removeClass("picflex listview").addClass(t).find(".resultitem").removeAttr("style").find(".thumbMeta").toggleClass("col-12 col-sm-12") : ($(".viewchange").removeClass("picflex listview").addClass(t).find(".thumbMeta").toggleClass("col-12 col-sm-12"), gallerfy())
